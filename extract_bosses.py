...
if __name__ == "__main__":
    xml_file = "knowledge_base/source/hollowknight_pages_current.xml"
    output_dir = None
    
    if not os.path.exists(xml_file):
        xml_file = os.path.join(os.path.dirname(__file__), xml_file)
    ...
    extract_boss_pages(xml_file, output_dir)