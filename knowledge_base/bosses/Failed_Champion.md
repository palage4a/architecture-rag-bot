...
* Leap: Failed Champion only uses this attack after the first Phase. This makes Leaping Bludgeon much more common.
...
= Screenshot HK  Failed Champion after defeat
= Screenshot HK  Arena in False Knight's dream
= Godhome Arena Failed Arena in Godhome
= Failed Champion Radiant (Hitless) Hollow Knight
