...
Location in the Resting Grounds
Nail Cast attack
= Screenshot HK  Xero at his grave
= Screenshot HK  Arena in the Resting Grounds
= Godhome Arena Xero Attuned Arena in Godhome
= Godhome Arena Xero Ascended/Radiant Arena in Godhome
= Xero Radiant (Hitless) Hollow Knight

## Trivia

* His grave message used to read "Here lies a Traitor", which was changed to the current message ("Cursed are those who turn against the King.") after the public release version 1.0.2.8.
